...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(jQueryModule || window.jQuery, window);
  } else {
  }
})(function(scope) {
  ...
  */
  ...
  window.GridStackUI = GridStack;

  window.GridStackUI.Utils = Utils;
  window.GridStackUI.Engine = GridStackEngine;
  window.GridStackUI.GridStackDragDropPlugin = GridStackDragDropPlugin;
